...
@section('page-title', 'รายละเอียดแผนก')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-gray-800">ข้อมูลแผนก</h2>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-medium text-gray-500">ชื่อแผนก</div>
                <div class="col-span-2 text-sm text-gray-900">{{ $department->department_name }}</div>
            </div>

            <!-- Department Type -->
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-medium text-gray-500">ประเภท</div>
            ...
            <!-- Users Count -->
            <div class="grid grid-cols-3 gap-4">
                <div class="text-sm font-medium text-gray-500">จำนวนผู้ใช้งาน</div>
                <div class="col-span-2">
                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800">
                        {{ $department->users->count() }} คน
                    </span>
                </div>
            </div>
            ...
            @if ($department->users->count() > 0)
                <div class="pt-4 border-t border-gray-200">
                    <h3 class="text-sm font-medium text-gray-700 mb-4">ผู้ใช้งานในแผนกนี้</h3>
                    <div class="space-y-2">
