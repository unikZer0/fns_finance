...
@section('page-title', 'เพิ่มแผนกใหม่')
        ...
        <form action="{{ route('admin.departments.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                <label for="department_type" class="block text-sm font-medium text-gray-700 mb-2">
                    ประเภทแผนก <span class="text-red-500">*</span>
                </label>
                <input type="text" name="department_type" id="department_type" value="{{ old('department_type') }}" 
