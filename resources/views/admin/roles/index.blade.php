...
<div class="table-wrapper">
    ...
    <div class="filter-bar">
        <form id="filter-form" method="GET" action="{{ route('admin.roles.index') }}" style="display:flex; flex-wrap:wrap; gap:12px; width:100%;">
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="4"><div class="empty-state"><div class="empty-title">ບໍ່ພົບຂໍ້ມູນບົດບາດ</div></div></td></tr>
            @endforelse
        </tbody>
    </table>
