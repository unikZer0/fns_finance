...
@section('title', 'ເພີ່ມບົດບາດ')
@section('page-title', 'ເພີ່ມບົດບາດໃໝ່')
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST">
            ...
            <div style="display:flex; flex-direction:column; gap:16px;">
                <div class="form-group">
                    ...
                    <input type="text" name="role_name" id="role_name" value="{{ old('role_name') }}" class="form-input" placeholder="ປ້ອນຊື່ບົດບາດ">
