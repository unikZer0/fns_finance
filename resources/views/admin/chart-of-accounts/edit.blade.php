        ...
        <form action="{{ route('admin.chart-of-accounts.update', $chartOfAccount) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                <label for="parent_id" class="block text-sm font-medium text-gray-700 mb-2">
                    ບັນຊີຫຼັກ (Parent Account)
                </label>
                <select name="parent_id" id="parent_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('parent_id') border-red-500 @enderror">
