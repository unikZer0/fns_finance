        ...
        <form action="{{ route('admin.chart-of-accounts.store') }}" method="POST">
            ...
            <div style="display:flex; flex-direction:column; gap:16px;">
                <div class="form-group">
                    ...
                    <input type="text" name="account_code" id="account_code" value="{{ old('account_code') }}" class="form-input" style="font-family:monospace;" placeholder="ປ້ອນລະຫັດບັນຊີ">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="account_name" id="account_name" value="{{ old('account_name') }}" class="form-input" placeholder="ປ້ອນຊື່ບັນຊີ">
