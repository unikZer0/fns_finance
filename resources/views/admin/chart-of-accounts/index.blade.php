...
<div class="table-wrapper">
    <div class="table-header">
        ...
        <div style="display: flex; gap: 8px;">
            <button type="button" id="bulkDeleteBtn" class="btn btn-danger" style="display: none;" onclick="openBulkDeleteModal('{{ route('admin.chart-of-accounts.bulk_destroy') }}')">
    ...
    <div class="filter-bar">
        <form id="filter-form" method="GET" action="{{ route('admin.chart-of-accounts.index') }}" style="display:flex; flex-wrap:wrap; gap:12px; width:100%; align-items:center;">
    ...
    <table>
        ...
        <tbody>
            @forelse ($chartOfAccounts as $account)
                <tr>
                    <td style="text-align: center;"><input type="checkbox" class="rowCheckbox form-checkbox" value="{{ $account->id }}"></td>
                    <td>{{ $account->id }}</td>
            ...
            @empty
                <tr><td colspan="6"><div class="empty-state"><div class="empty-title">ບໍ່ພົບຂໍ້ມູນບັນຊີ</div></div></td></tr>
            @endforelse
        </tbody>
    </table>
