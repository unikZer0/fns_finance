<aside id="admin-sidebar" class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        {{-- Section: ການຈັດການ --}}
        <div class="sidebar-section-label">ການຈັດການ</div>
        ...
        @can ("head_of_finance")
            <a href="{{ route('head_of_finance.annual-budget.index') }}"
                class="nav-item {{ request()->routeIs('head_of_finance.annual-budget.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('head_of_finance.budget-installment.index') }}"
                class="nav-item {{ request()->routeIs('head_of_finance.budget-installment.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('head_of_finance.academic_income.index') }}"
                class="nav-item {{ request()->routeIs('head_of_finance.academic_income.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('head_of_finance.salary.index') }}"
                class="nav-item {{ request()->routeIs('head_of_finance.salary.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                </svg>
                ແຜນເງິນເດືອນ
            ...
            <a href="{{ route('head_of_finance.expense.index') }}"
                class="nav-item {{ request()->routeIs('head_of_finance.expense.*') && !request()->routeIs('head_of_finance.expense.balance') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('head_of_finance.balance.index') }}"
                class="nav-item {{ request()->routeIs('head_of_finance.balance.*') || request()->routeIs('head_of_finance.expense.balance') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        @if (auth()->user()->reviewerAssignments()->exists() && !in_array(auth()->user()->role?->role_name, ['deputy_head_of_faculty', 'head_of_faculty']))
            <a href="{{ route('head_of_department.annual-budget.index') }}"
                class="nav-item {{ request()->routeIs('head_of_department.annual-budget.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                </svg>
                ກວດສອບແຜນງົບປະມານ
        ...
        @can ("deputy_head_of_faculty")
            @if (auth()->user()->reviewerAssignments()->whereHas('budgetPlan', function ($q) { $q->where('status', 'PENDING_REVIEW'); })->exists())
                <a href="{{ route('deputy_head_of_faculty.annual-budget.index') }}"
                    class="nav-item {{ request()->routeIs('deputy_head_of_faculty.annual-budget.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                    </svg>
                    ກວດສອບແຜນງົບປະມານ
        ...
        @can ("head_of_faculty")
            <a href="{{ route('head_of_faculty.annual-budget.index') }}"
                class="nav-item {{ request()->routeIs('head_of_faculty.annual-budget.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
