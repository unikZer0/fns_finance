...
@section('title', 'ປະເມີນລາຍຮັບ')
@section('page-title', 'ປະເມີນລາຍຮັບ')
...
@section('content')
    ...
    <section class="ai-hero">
        <div class="ai-hero-text">
            ...
            <h2 class="ai-hero-title">ແຜນປະເມີນລາຍຮັບ</h2>
    ...
    <div class="ai-card-grid" id="planGrid">
        @forelse($plans as $plan)
            ...
            <article class="ai-card {{ $isCurrent ? 'ai-card-current' : '' }}" data-year="{{ $plan->fiscal_year }}"
        ...
        <div class="ai-modal">
            <div class="ai-modal-head">
                <div>
                    ...
                    <h3 id="createPlanTitle" class="ai-modal-title">ປະເມີນລາຍຮັບ</h3>
                </div>
    ...
    <style>
        ...
        .ai-hero-cta {
            ...
            border-radius: 10px;
            background: var(--fns-gold, #c9991a);
        ...
        .ai-card-current::before {
            background: linear-gradient(to bottom, var(--fns-gold), var(--fns-gold-light, #e7be4f));
        }
        ...
        .ai-card-foot {
            display: flex;
            gap: .5rem;
            padding: .8rem 1.15rem .85rem 1.4rem;
            align-items: center;
        }
