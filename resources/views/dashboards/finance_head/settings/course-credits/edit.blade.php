...
@section('title', 'ແກ້ໄຂໜ່ວຍກິດຕາມຫຼັກສູດ')
@section('page-title', 'ແກ້ໄຂໜ່ວຍກິດຕາມຫຼັກສູດ')

@section('content')
<div class="fns-card" style="max-width:560px;">
    @php $setting = $courseCredit; @endphp
    <form method="POST" action="{{ route('head_of_finance.settings.course-credits.update', $courseCredit) }}">
        @csrf @method('PUT')
