    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <h1 class="text-2xl font-bold text-blue-600 mb-2">💼 Head of Finance Dashboard</h1>
                ...
                <hr class="my-4">
                <p class="text-gray-500 text-sm">You can approve financial requests and manage budget overview here.</p>
            </div>
        </div>
    </div>
</x-app-layout>
